    ...
    <section className="pt-0 md:pt-8 pb-16 overflow-hidden relative">
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="flex flex-col items-center justify-center text-center relative">
          ...
          <div className="absolute -right-20 md:-right-32 top-1/2 -translate-y-1/2 w-2/4 max-w-[400px] hidden md:block">
            <img 
          ...
          <div className="md:hidden w-[95%] max-w-[320px] mx-auto mt-8">
            <img 
              src="/lovable-uploads/84bddbc7-cf5d-4ae5-bd57-6bff30321134.png" 
              alt="Lemon character on envelope" 
              className="w-full h-auto animate-float"
