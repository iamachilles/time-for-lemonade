        ...
        <div className="max-w-6xl mx-auto relative overflow-hidden">
          ...
          <div className="relative glass-card p-6 md:p-12 rounded-3xl border-2 border-white/70 overflow-hidden">
            ...
            <div className="relative text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-6 md:mb-8 animate-slide-up" style={{ animationDelay: "0.1s" }}>
              ...
              <p className="text-gray-500 mt-4 md:mt-6 text-sm md:text-base animate-slide-up" style={{ animationDelay: "0.3s" }}>
