...
const FeatureCard = ({ 
  ...
  if (imageSrc) {
    return (
      <div className={`absolute ${position} z-30 max-w-[110px] animate-float`} style={{
  ...
  return (
    <div className={`absolute ${position} rounded-lg p-4 shadow-lg ${color} ${textColor} z-30 max-w-[110px] animate-float`} style={{
